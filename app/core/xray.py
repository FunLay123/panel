...
class XRayConfig(dict):
    ...
    def _handle_xhttp_settings(self, net_settings: dict, settings: dict, inbound_tag: str = ""):
        ...
        settings["session_placement"] = get_xhttp_value("sessionIDPlacement") or settings["session_placement"] = get_xhttp_value("sessionPlacement")  
        settings["session_key"] = get_xhttp_value("sessionIDKey") or settings["session_key"] = get_xhttp_value("sessionKey")
